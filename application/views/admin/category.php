          ...
          <div class="box-body">
		    <table id="example2" class="table table-bordered table-hover">
			  ...
			  <tr>
			    ...
			    <td>
			     <div class="tools">
			  	   <a href="<?php echo $category['link'];?>" class="btn btn-primary"><i class="fa fa-edit"></i></a>
			  	   <a href="#" data-href="<?php echo $category['delete_link'];?>" class="btn btn-danger" data-toggle="modal" data-target="#confirm-delete"><i class="fa fa-trash-o"></i></a>
			     </div>
			    </td>                
			  </tr>
		      <?php } ?>
