            ...
            <div class="page_title_wrapper">
                <div class="page_title_inner">
                    <div class="page_title_content">
                        <h1 class="withtopbar">Rent a car</h1>
                                    ...
                                    <div class="one_third gallery3 classic static filterable portfolio_type themeborder" data-id="post-2">
                                        ...
                                        <div class="portfolio_info_wrapper">
                                            <div class="car_attribute_wrapper">
                                                <a class="car_link" href="<?php  echo base_url('rent-a-car/').$rent_a_cars['link'];?>"><h4><?php echo  $rent_a_cars['title']?></h4></a>
                                            ...
                                            <div class="car_attribute_price">
                                                <div class="car_attribute_price_day three_cols">
                                                    <span class="single_car_currency">£</span><span class="single_car_price"><?php echo $rent_a_cars['price'];?></span> <span class="car_unit_day">Per Day</span>
                                                </div>
                                            </div>
                                            <br class="clear" />
                                        </div>
