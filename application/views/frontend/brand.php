...
<div id="page_caption" class="hasbg parallax  withtopbar  " style="background-image:url(<?php echo base_url('template/')?>upload/driver-2.jpg);">
            ...
            <div class="page_title_wrapper">
                <div class="page_title_inner">
                    <div class="page_title_content">
                        <h1 class="withtopbar"><?php if(!empty($brand_name)){ echo $brand_name; }?></h1>
        ...
        <div id="page_content_wrapper" class="hasbg withtopbar ">
		  <!--form class="form-horizontal" action="<?php echo base_url();?>rent-a-car" method="GET">
			   <div class="wrapper1">
	  ...
	  <?php   
		...
		$upper=isset($_GET['upper']) ? $_GET['upper'] : '';	
		  ...
		  if($lower || $upper){
			$rent_a_car = $this->db->get('rent_a_car')->result_array();
		  }
  
       if(!empty($category)){
        $rent_a_car=$this->db->order_by('id','desc')->get_where('rent_a_car',array('category_id'=>$category[0]['category_id']))->result_array();
		$rent_to_buy=$this->db->order_by('id','desc')->get_where('rent_to_buy',array('category_id'=>$category[0]['category_id']))->result_array();
		$sell_a_car=$this->db->order_by('id','desc')->get_where('sell_a_car',array('category_id'=>$category[0]['category_id']))->result_array();
                                ...
                                <div class="element grid classic3_cols animated2">
                                    ...
                                    <div class="one_third gallery3 classic static filterable portfolio_type themeborder" data-id="post-2">
                                        <a class="car_image" href="#">
                                            <img src="<?php echo base_url().$sub_data['image']?>" alt="<?php echo  $sub_data['title']?>" />
                                        </a>

                                        <div class="portfolio_info_wrapper">
                                            <div class="car_attribute_wrapper">
											 <?php if($sub_data['car_type']=='rent_a_car'){?>
                                                <a class="car_link" href="<?php  echo base_url('rent-a-car/').$sub_data['link'];?>"><h4><?php echo  $sub_data['title']?></h4></a>
											 <?php } else if($sub_data['car_type']=='rent_to_buy'){ ?>
											 
											    <a class="car_link" href="<?php  echo base_url('rent-to-buy/').$sub_data['link'];?>"><h4><?php echo  $sub_data['title']?></h4></a>
											 <?php } else if($sub_data['car_type']=='sell_a_car'){ ?>
											    <a class="car_link" href="<?php  echo base_url('sell-a-car/').$sub_data['link'];?>"><h4><?php echo  $sub_data['title']?></h4></a>
											 <?php }?>
                                            ...
                                            <div class="car_attribute_price">
                                                <div class="car_attribute_price_day three_cols">
                                                    <span class="single_car_currency">£</span><span class="single_car_price"><?php echo $sub_data['price'];?></span> <span class="car_unit_day"></span>
                                                </div>
                                            </div>
                                            <br class="clear" />
                                        </div>
